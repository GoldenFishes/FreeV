...
def plot_multiple_relative_log_frequencies(image_filenames, alpha=0.8):
    ...
    cmap = get_cmap('Blues')   #Oranges/ Purples

    # new_labels = ["0.8","0.9","1.0","1.1","1.2"]
    # new_labels = ["0.9", "0.95", "1.0", "1.05", "1.1"]
    new_labels = ["0.4", "0.7", "1.0", "1.3", "1.6"]
...
# image_filenames = ["b0.8.png", "b0.9.png", "0.png", "b1.1.png", "b1.2.png"]
# image_filenames = ["f0.9.png", "f0.95.png", "0.png", "f1.05.png", "f1.1.png"]
image_filenames = ["s0.4.png", "s0.7.png", "0.png", "s1.3.png", "s1.6.png"]
